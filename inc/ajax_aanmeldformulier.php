...
function efiber_haal_aanmeldformulier() {
	...
	{
		$svgs = "<img class='ja-schuif' src='/wp-content/plugins/efiber/iconen-nieuw/png/ja schuif.png' alt='ja' width='65' height='27'/><img class='nee-schuif' src='/wp-content/plugins/efiber/iconen-nieuw/png/nee schuif.png' alt='nee' width='65' height='27'/>";
	}
	...
	if (in_array('Alles in 1', $eigenschappen['pakket_type']) || in_array('Internet en TV', $eigenschappen['pakket_type'])) :
		...
		if ( kz_heeft_optie('extra-tv-ontvangers', $eigenschappen) ) :
			...
			$nummer_svgs = "<span class='plus-en-min-svgs'>
				<a href='#' class='knop' data-efiber-func='aantal-tvs-min'>
				...
				<a href='#' class='knop' data-efiber-func='aantal-tvs-plus'>
			...
			$veld1 = $nummer_svgs . efiber_input (array(
