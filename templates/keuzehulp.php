...
function keuzehulp_keuzehulp_pak_afb ($str = '') {
	global $afb_pad;
	$class = explode(' ', $str);
...
<div class='keuzehulp'><div class='verpakking'>
	...
	<?php
		...
		$keuzehulp_of_niet = new KzSectie(array(
			'stap'			=> 2,
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("gefeliciteerd titel"),
		...
		$knop->attr = 'data-kz-situatie-keuze="klein-huishouden"';
		...
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("huishouden 1");
		$kies_situatie_knoppen .= $knop->maak();

		$knop->attr = 'data-kz-situatie-keuze="gezin"';
		$knop->tekst = $situatie_teksten['gezin'];
		$knop->tooltip = $situatie_teksten['gezin_tooltip'];
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("huishouden 2");
		$kies_situatie_knoppen .= $knop->maak();
		...
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("huishouden 3");
		$kies_situatie_knoppen .= $knop->maak();

		$knop->attr = 'data-kz-situatie-keuze="bedrijf"';
		...
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("huishouden 4");
		$kies_situatie_knoppen .= $knop->maak();

		$kies_situatie = new KzSectie(array(
			'stap'			=> 3,
			'titel'			=> $situatie_teksten['titel'],
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("huishouden titel"),
		...
		$knop->attr = 'data-kz-situatie-keuze="klein-zakelijk"';
		$knop->func = 'animeer zet-niveau-knop zet-situatie toon-stap zet-nummers-consequentie';
		$knop->link = '#5';
		...
		$kies_klein_zakelijk = new KzSectie(array(
			'stap'			=> 4,
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("huishouden titel"),
		...
		$knop->link = '#6';
		$knop->attr = 'data-kz-internet-keuze="1"';
		$knop->geen_ikoon = false;
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("internet 1");
		...
		$knop->attr  = 'data-kz-internet-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("internet 2");
		$kies_internet_knoppen .= $knop->maak();
		...
		$knop->attr  = 'data-kz-internet-keuze="3"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("internet 3");
		$kies_internet_knoppen .= $knop->maak();
		...
		$knop->attr  = 'data-kz-internet-keuze="4"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("internet 4");
		$kies_internet_knoppen .= $knop->maak();

		$kies_internet = new KzSectie(array(
			'stap'			=> 5,
			'titel'			=> $kies_internet_teksten['titel'],
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("internet titel"),
		...
		$knop->link = '#8';
		$knop->attr = 'data-kz-bellen-keuze="1"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("bellen 1");
		...
		$knop->attr  = 'data-kz-bellen-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("bellen 2");
		$kies_bellen_knoppen .= $knop->maak();
		...
		$knop->link = '#7';
		$knop->attr  = 'data-kz-bellen-keuze="3"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("bellen 3");
		$kies_bellen_knoppen .= $knop->maak();

		$kies_bellen = new KzSectie(array(
			'stap'			=> 6,
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("bellen titel"),
		...
		$knop->link = '';
		$knop->attr = 'data-kz-nummers-keuze="1"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("nummer 1");
		...
		$knop->attr  = 'data-kz-nummers-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("nummer 2");
		$kies_nummers_knoppen .= $knop->maak();

		$kies_nummers = new KzSectie(array(
			'stap'			=> 7,
			'titel'			=> $kies_nummers_teksten['titel'],
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("nummer titel"),
		...
		$knop->attr  = 'data-kz-televisie-keuze="5"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie 5");
		$knop->link = '#11';
		...
		$knop->link = '#9';
		$knop->attr  = 'data-kz-televisie-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie 2");
		$kies_televisie_knoppen .= $knop->maak();

		$knop->tekst = $televisie_teksten['interactief_tv'];
		$knop->tooltip = $televisie_teksten['interactief_tv_tooltip'];
		$knop->attr  = 'data-kz-televisie-keuze="3"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie 3");
		$kies_televisie_knoppen .= $knop->maak();

		$knop->tekst = $televisie_teksten['alleen_netflix'];
		$knop->tooltip = $televisie_teksten['alleen_netflix_tooltip'];
		$knop->link = '#11';
		$knop->attr = 'data-kz-televisie-keuze="1"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie 1");
		$kies_televisie_knoppen .= $knop->maak();

		$knop->tekst = $televisie_teksten['tevreden'];
		$knop->tooltip = $televisie_teksten['tevreden_tooltip'];
		$knop->attr  = 'data-kz-televisie-keuze="4"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie 4");
		$kies_televisie_knoppen .= $knop->maak();


		$kies_televisie = new KzSectie(array(
			'stap'			=> 8,
			'titel'			=> $televisie_teksten['titel'],
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("televisie titel"),
		...
		$knop->attr = 'data-kz-televisie-opties-keuze="1"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie opties 1");
		...
		$knop->attr  = 'data-kz-televisie-opties-keuze="5"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie opties 5");
		$kies_televisie_opties_knoppen .= $knop->maak();

		$knop->tekst = $televisie_opties_teksten['meerdere_tvs'];
		$knop->tooltip = $televisie_opties_teksten['meerdere_tvs_tooltip'];
		$knop->attr  = 'data-kz-televisie-opties-keuze="6"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie opties 6");
		$kies_televisie_opties_knoppen .= $knop->maak();
		...
		$knop->attr  = 'data-kz-televisie-opties-keuze="3"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie opties 3");
		$kies_televisie_opties_knoppen .= $knop->maak();
		...
		$knop->attr  = 'data-kz-televisie-opties-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie opties 2");
		$kies_televisie_opties_knoppen .= $knop->maak();

		$knop->tekst = $televisie_opties_teksten['extra_veel_zenders'];
		$knop->tooltip = $televisie_opties_teksten['extra_veel_zenders_tooltip'];
		$knop->attr  = 'data-kz-televisie-opties-keuze="4"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("televisie opties 4");
		$kies_televisie_opties_knoppen .= $knop->maak();

		$kies_televisie_opties = new KzSectie(array(
			'stap'			=> 9,
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("televisie opties titel"),
		...
		$knop->link = '#30';
		$knop->attr = 'data-kz-installatie-keuze="1"';
		$knop->geen_ikoon = false;
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("installatie 1");
		...
		$knop->attr  = 'data-kz-installatie-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("installatie 2");
		$kies_installatie_knoppen .= $knop->maak();

		$knop->tekst = $installatie_teksten['iemand_alles_installeert'];
		$knop->tooltip = $installatie_teksten['iemand_alles_installeert_tooltip'];
		$knop->attr  = 'data-kz-installatie-keuze="3"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("installatie 3");
		$kies_installatie_knoppen .= $knop->maak();

		$kies_installatie = new KzSectie(array(
			'stap'			=> 11,
			'titel'			=> $installatie_teksten['titel'],
			'torso_intro'	=> $installatie_teksten['intro'],
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("installatie titel"),
		...
		$knop->attr  = 'data-kz-ik-weet-wat-ik-wil-keuze="1"';
		...
		$knop->attr  = 'data-kz-ik-weet-wat-ik-wil-keuze="2"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("internet-en-bellen");
		$kies_pakket_knoppen .= $knop->maak();

		$knop->tekst = $iwwiw_teksten['internet_en_tv'];
		$knop->tooltip = $iwwiw_teksten['internet_en_tv_tooltip'];
		$knop->attr  = 'data-kz-ik-weet-wat-ik-wil-keuze="3"';
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("internet-en-tv");
		$kies_pakket_knoppen .= $knop->maak();

		$knop->tekst = $iwwiw_teksten['alles_in_1'];
		$knop->tooltip = $iwwiw_teksten['alles_in_1_tooltip'];
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("alles-in-1");
		$knop->attr  = 'data-kz-ik-weet-wat-ik-wil-keuze="4"';
		$kies_pakket_knoppen .= $knop->maak();
		...
		$knop->link = '#50';
		$knop->attr = false;
		$knop->ikoon = keuzehulp_keuzehulp_pak_afb("huishouden 5");
		$kies_pakket_knoppen .= $knop->maak();

		$kies_pakket = new KzSectie(array(
			'stap'			=> 20,
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("pakketten vinkje titel"),
		...
		$print_provider_pakketten = new KzSectie(array(
			'stap'			=> 21,
			//'titel_afb'		=> keuzehulp_keuzehulp_pak_afb("pakketten vinkje titel"),
		...
		$print_vergelijking = new KzSectie(array(
			'stap'			=> 30,
		...
		$contactformulier_zakelijk = new KzSectie(array(
			'stap'			=> 50,
		...
		$contactformulier_lead = new KzSectie(array(
			'stap'			=> 51,
		...
		$aanmeldformulier = new KzSectie(array(
			'stap'			=> 100,
